...
},{"./cookieconsent":"../cookieconsent.js","uikit/dist/js/uikit.min":"../node_modules/uikit/dist/js/uikit.min.js","uikit/dist/js/uikit-icons.min":"../node_modules/uikit/dist/js/uikit-icons.min.js"}],"../contact.js":[function(require,module,exports) {
"use strict";
...
var FormValidate = /*#__PURE__*/function () {
  function FormValidate(form, options) {
    ...
    this.options = Object.assign({}, defaultOptions, options); //wyłączamy walidację HTML
  ...
  _createClass(FormValidate, [{
    ...
    value: function getFields() {
      var inputs = _toConsumableArray(this.form.querySelectorAll("input:not(:disabled), select:not(:disabled), textarea:not(:disabled)"));
    ...
    value: function prepareElements() {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          ...
          if (type === "checkbox" || type === "radio" || type === "tel" || tag === "select") {
            //checkboxa i radio
            eventName = "change";
          }

          el.addEventListener(eventName, function (e) {
            return _this.testInput(e.target);
          });
        }
      } catch (err) {
        _iterator2.e(err);
    ...
    key: "testInput",
    value: function testInput(input) {
      var valid = input.checkValidity();
      this.markFieldAsError(input, !valid);
      return valid;
    }
  }, {
    key: "markFieldAsError",
    value: function markFieldAsError(field, show) {
      if (show) {
      ...
      this.form.addEventListener("submit", function (e) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _this2.markFieldAsError(el, !el.checkValidity());
        ...
        if (!counter) {
          ...
          var _elements = _this2.getFields();

          var dataToSend = new FormData();

          _toConsumableArray(_elements).forEach(function (el) {
            return dataToSend.append(el.name, el.value);
          });
          ...
          fetch(url, {
            ...
            if (res.errors) {
              ...
              if (res.ok) {
                ...
                div.innerHTML = "<strong>Wiadomość została wysłana. </strong><p>Dziękujemy za kontakt. Postaramy się odpowiedzieć jak najszybciej</p>";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var fv = new FormValidate(form, cfg);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55461" + '/');
...
//# sourceMappingURL=/contact.043a603d.js.map